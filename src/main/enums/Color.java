...
public enum Color
{
	NONE("", "\u001B[0m"), RED("Pink", "\u001B[31m"), YELLOW("Yellow", "\u001B[33m"), GREEN("Green", "\u001B[32m"), BLUE("Blue",
			"\u001B[34m"), WHITE("White", "\u001B[37m"), RAINBOW("Rainbow", "\u001B[35m"), MULTI("Multi", "\u001B[35m");
	...
	/**
	 * @return Whether a card of this color can be hinted by the given color parameter
	 */
	public boolean isClueableBy(Color color)
	{
